    ...
    ##    MODEL_NAME='keras_model.h5'
        ...
        for num, data in enumerate(verify_data):
            ...
            if np.argmax(model_out) == 0:
                str_label = "Covid "
                print("The predicted image of the Covid is with a accuracy of {} %".format(model_out[0]*100))
                accuracy="The predicted image of the Covid is with a accuracy of {}%".format(model_out[0]*100)
